    ...
    <aside ref={sidebarRef} className="space-y-8 lg:sticky lg:top-28 lg:self-start">
      ...
      <div className={cn("opacity-0", isVisible && "animate-fade-in-up stagger-1")}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">{copy.categories}</h3>
        </div>
        <div className="space-y-1">
          {categories.map((category) => (
            ...
            >
              <span>{category.slug === "all" ? copy.allPosts : category.name}</span>
      ...
      <div className={cn("opacity-0", isVisible && "animate-fade-in-up stagger-2")}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">{copy.popularTags}</h3>
        </div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">{copy.newsletter}</h3>
        </div>
